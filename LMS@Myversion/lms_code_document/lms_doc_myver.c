...
/*****************************************************
*	Function for detection of Keyframe				 *
******************************************************/
compare_detect(Mat pFrame) 
{
...
/*****************************************************
*		Function for canny edge detction(class LMS)  *
******************************************************/
l_canny_edge(Mat c_image) 
{
...
/*****************************************************
*	Function for canny edge detction(class Keyframe) *
******************************************************/
Mat lms::k_canny_edge(Mat k_image) 
{
...
/*****************************************************
*	   Function for Length Computation 				 *
******************************************************/
compute_length() 
 {
